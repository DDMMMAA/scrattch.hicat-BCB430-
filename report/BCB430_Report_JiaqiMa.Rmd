...
![**Figure 8:** Global differentially expressed gene count; Y-axis is the number of significantly differentilly expressed gene; X-axis are groups separated by age, roi, and sex](figure/Global_DE_Counts.png)

<br>

The number of globally differentially expressed gene aligned with previous UMAP visualization grouped by metadata, which both indicate roi is the strongest contributor to cell heterogeneity followed by age and sex.

![**Figure 9:** Raw and normalized local differentially expressed gene count; Y-axis is each subclass grouped by three categories, 14 out of 16 subclass contain differentially expressed gene. Astroependymal and tanycyte doesn't contain differentially expressed gene because of insufficient number of cell; X-axis is the number of significantly differentially expressed gene; (A) Raw counts; (B) Normalizaed by averages number of genes detected per cell; (C) Normalized by the total number of genes detected per subclass. ](figure/DE_Counts_3Way_Comparison.png)
