...
* **The Transcriptomic Anomaly:** Why is *Gm47283*, a Y-linked gene, significantly upregulated in the transcriptomic profiles of female *Mus musculus*?
...
The clustering result were broadly consistent with the subclass annotations. However, four small clusters (20, 24, 25, 26), located at the boundary between the OPC and oligodendrocyte populations, were identified by clustering but were absent subclass annotations. Given that oligodendrocytes differentiate from OPCs ([Tiane et al., 2019](https://doi.org/10.3390/cells8101236)), these four clusters (20, 24, 25, 26) may represent intermediate differentiation states along the OPC-to-oligodendrocyte lineage.
...
-    X and Y Allele Pairwise Alignment: Conduct more accurate, localized pairwise alignment between the Gm47283 X and Y alleles to complement reciprocal BLAST result. Because BLAST searches for similar sequences across a large database, it employs algorithmic trade-offs (including small seed sizes and selective extension) to balance sensitivity with computational efficiency.

-    Isoform-to-Allele Pairwise Alignment: Align known X-allele isoforms against two genomic allele sequences to find if there exist an isoform aligned non-linearly against X-allele but linearly against Y-allele. This would directly test whether the hypothesised mismapping isoform exists among known X-allele transcripts.
...
This computational artefact underscores that robust cell type annotation requires evaluation of biological metadata alongside algorithmic assumptions. It is imperative to include sex as a biological variable in future scRNA-seq research. Failure to stratify by sex may generate both false-negative and false-positive conclusions.
