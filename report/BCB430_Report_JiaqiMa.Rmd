...
![**Figure 1:** BCB430 method roadmap; Number of cells retained in first two steps are indicated in red (Created in https://BioRender.com)](figure/bcb430_roadmap.png)
...
[Jin et al (2025)](https://doi.org/10.1038/s41586-024-08350-8) sequenced brain sample collected from 44 aged mice (20 female, 24 male) and 64 young adult mice (31 female, 33 male) using Illumina NovaSeq6000 sequencing system ([Modi et al, 2021](https://doi-org.myaccess.library.utoronto.ca/10.1007/978-1-0716-1099-2_2)) and 10X Genomics CellRanger pipeline (v.6.0.0) to assemble sequenced reads to `mm10/gencode.vM23` reference genome ([Frankish et al, 2019](https://doi-org.myaccess.library.utoronto.ca/10.1093/nar/gky955)). The raw sequence data contains `2,777,165` cells categorized in 6 major regions, 16 broad regions.
...
![**Figure 2:** Schematic of dissected brain regions; The red box indicates subsetted regions. (Modified from [Jin et al, 2025; Figure 1](https://doi.org/10.1038/s41586-024-08350-8)
)](figure/allen_region.png)

![**Figure 3:** Schematic of hierarchical "Cell type" annotation; The red box indicates subsetted classes. (Modified from [Jin et al, 2025; Figure 1](https://doi.org/10.1038/s41586-024-08350-8)
