...
![**Figure 8:** Global differentially expressed gene (DEG) count; Y-axis is the number of significantly differentilly expressed gene; X-axis are groups separated by age, roi, and sex](figure/Global_DE_Counts.png)
...
![**Figure 10:** Expression level of Gm47283 across 16 glial subclasses between sex, upregulated in female in 10 out of 16 subclalsses; Y-axis is the normalized expression level; X-axis is all 16 glial subclass separated by sex; Significance level are denoted above each subcalss (***: adjusted p < 0.001; ns: not significant)](figure/Gm47283 expression level whole glia.png)
...
![**Figure 11:** Synteny of Gm47283 on GRCm38/mm10 reference genome; The red box on top indicate the location on Y chromosome](figure/chrY_back.png)

<br>

![**Figure 12:** Synteny of top 4 Y-linked DEG upregulated in male on GRCm38/mm10 reference genome; The red box on top indicate the location on Y chromosome](figure/chrY_front.png)
...
![**Figure 13:** Schematic of human pseudoautosomal region (PAR) lighlighted in purple on each tip of sex chromosome](figure/pseudoautosomal_region.png)
...
![**Figure 14:** Gm47283 Reciprocal BLAST result; The left panel is X-allele query; The right panel is Y-allel query; X and Y chromosome hit in both query were checked and visualized using graphical representation tool in BLAST website](figure/reciprocal_BLAST.png)
...
![**Figure 15:** Gm47283 interspecies BLAST result; The left panel is X-allele query; The right panel is Y-allel query; Human chromosome 21 hits both query were checked and visualized using graphical representation tool in BLAST website](figure/mice_to_human_BLAST.png)
