...
![**Figure 17:** *Gm47283* Reciprocal BLAST result; The left panel is X-allele query; The right panel is Y-allele query; X and Y chromosome hit in both queries were checked and visualized using graphical representation tool in BLAST website](figure/reciprocal_BLAST.png)
...
![**Figure 18:** *Gm47283* interspecies BLAST result; The left panel is X-allele query; The right panel is Y-allele query; Human chromosome 21 hits both queries were checked and visualized using graphical representation tool in BLAST website](figure/mice_to_human_BLAST.png)
