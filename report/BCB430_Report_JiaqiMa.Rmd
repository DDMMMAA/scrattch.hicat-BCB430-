...
The identification of this mapping artifact exposes a critical technical limitation: standard short-read scRNA-seq is not a suitable tool to study pseudoautosomal regions (PARs). Because short-read alignment algorithms cannot distinguish true chromosomal origins across highly similar sequences, the corresponding count matrices for these loci are unreliable. This realization prompts two vital questions for future investigations. First, it is necessary to ask whether there are other genomic regions similar to the pseudoautosomal region—specifically, highly homologous loci where a spliced isoform transcribed non-linearly from one allele can be erroneously mapped linearly to a different allele. Identifying such regions is critical for allele-specific research utilizing scRNA-seq, as it allows researchers to systematically flag and compensate for unreliable genomic coordinates. Second, investigate whether there is anything uniquely significant about the hypothetical isoform compared to other isoforms. Considering that this isoform can be actively transcribed from both the X and Y alleles despite their structural truncation differences, it strongly implies that the resulting transcript is biologically indispensable for both males and females.
