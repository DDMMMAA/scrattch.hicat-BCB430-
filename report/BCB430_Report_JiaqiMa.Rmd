...
![Figure 1: BCB430 method roadmap; Number of cells retained in first two steps are indicated red (created in https://BioRender.com)](figure/bcb430_roadmap.png)
...
![Figure 2: Schematic of dissected brain regions; The red box indicate subsetted regions. (Modified from [Jin et al, 2025; Figure 1](https://doi.org/10.1038/s41586-024-08350-8)
)](figure/allen_region.png)

![Figure 3: Schematic of hierarchical "Cell type" annotation; The red box indicate subsetted classes. (Modified from [Jin et al, 2025; Figure 1](https://doi.org/10.1038/s41586-024-08350-8)
...
![Figure 4: Proposed mechanism of Gm47283 reads misassembly. The schematic illustrates a hypothetical algorithmic error during the reads assembly phase of Gm47283. The true genomic locus of the Gm47283 X-allele (top) consists of defined exonic regions (boxes) separated by intronic sequences (lines). Transcription and splicing produce a mature isoform devoid of introns (middle). The hypothesis proposed that this processed, continuous isoform was assembled to contineous Y-allele (bottom) under linear assumption of assembly algorithm, resulting misassembly. (created in https://BioRender.com)](figure/Hypothetical_misassembly.png)
